...
const LAYERS: PortalLayer[] = [
  ...
  { id: 'colisiones', group: 'condor', n: 'Colisiones confirmadas', src: 'Parques eólicos 2019–2025 · 29 registros', sw: '#a4441e', on: false, buffer: { on: false, km: 5 }, help: '29 colisiones confirmadas de cóndor con aerogeneradores (2019–2025), georreferenciadas por caso (fecha, proyecto, sexo y edad). Alimenta el criterio «Historial de colisiones cercanas» (por defecto 5 %, influencia 10 km). Solo casos informados.' },
  // Atrayentes de carroña
  { id: 'vertederos', group: 'carrona', n: 'Vertederos (formales e ilegales)', src: 'MMA', sw: '#8a4b12', on: false, buffer: { on: false, km: 10 }, help: '356 vertederos formales e ilegales (MMA). Fuente de carroña que atrae el vuelo del cóndor. Alimenta el criterio «Cercanía a vertederos» (por defecto 10 %, influencia 15 km).' },
  { id: 'veranadas', group: 'carrona', n: 'Veranadas', src: 'Ganadería (trashumancia)', sw: '#6f7a45', on: false, buffer: { on: false, km: 15 }, help: '631 polígonos de veranadas: zonas de pastoreo estival del ganado trashumante en cordillera, fuente de carroña. Alimenta el criterio «Cercanía a veranadas» (por defecto 5 %, influencia 30 km).' },
  { id: 'ganado_bovino', group: 'carrona', n: 'Ganado bovino', src: 'Ganadería · cabezas por distrito', sw: '#b5651d', on: false, help: 'Cabezas de ganado bovino por distrito, dibujadas en el centroide del distrito con tamaño proporcional al número de cabezas (las tres especies comparten ubicación y se distinguen por tamaño). Alimenta el criterio «Carga ganadera regional» (por defecto 5 %, influencia 30 km).' },
  { id: 'ganado_ovino', group: 'carrona', n: 'Ganado ovino', src: 'Ganadería · cabezas por distrito', sw: '#caa472', on: false, help: 'Cabezas de ganado ovino por distrito, dibujadas en el centroide del distrito con tamaño proporcional al número de cabezas (las tres especies comparten ubicación y se distinguen por tamaño). Alimenta el criterio «Carga ganadera regional» (por defecto 5 %, influencia 30 km).' },
  { id: 'ganado_caprino', group: 'carrona', n: 'Ganado caprino', src: 'Ganadería · cabezas por distrito', sw: '#9c7a3c', on: false, help: 'Cabezas de ganado caprino por distrito, dibujadas en el centroide del distrito con tamaño proporcional al número de cabezas (las tres especies comparten ubicación y se distinguen por tamaño). Alimenta el criterio «Carga ganadera regional» (por defecto 5 %, influencia 30 km).' },
  // Otras especies
  ...
  { id: 'wind', group: 'eolico', n: 'Parques Eólicos (OPC)', src: 'MINENERGIA', sw: '#c0392b', on: false, buffer: { on: false, km: 2 }, help: '30 parques eólicos en operación (MINENERGIA). Alimenta el criterio «Cercanía a parques eólicos» (por defecto 20 %, influencia 3 km) y es la base del ranking del tab Comité.' },
  { id: 'turb', group: 'eolico', n: 'Aerogeneradores', src: 'MINENERGIA · jun 2026', sw: '#8f8168', on: false, help: '7.162 aerogeneradores (MINENERGIA, junio 2026, todos los estados). Capa de contexto: no entra al índice (el criterio de cercanía usa los parques eólicos en operación).' },
